import { defineComponent, createApp, h, CSSProperties } from "vue";
import type { SpinConfig, SpinInstance } from "./types";
...
/** @name 创建Spin组件 **/
export const createSpinComponent = (options: SpinConfig) => {
...
/** 入口函数 **/
const spin = (options: SpinConfig = {}): SpinInstance => {
...
/** 配置预处理，主要处理额外扩展的target属性，target不传，则默认使用body作为挂载节点 **/
